...
describe("Store repository tests", () => {
    ...
    it("Should create a store", async () => {
        ...
        const storeModel = await StoreModel.findOne({ where: {id: store.id }, include: ["address"] });
    ...
    it("Should update a store", async () => {
        ...
        const storeModel2 = await StoreModel.findOne({ where: {id: store.id }, include: ["address"] });
